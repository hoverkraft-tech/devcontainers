# Dev Container Features: hoverkraft-tech

## Example Contents

This repository contains a _collection_ devcontainer features.
Each sub-section below shows a sample `devcontainer.json` alongside example usage of the Feature.

### `asdf`

Install asdf (after v0.16.0 - the go rewrite) globally and configure it for each user.
